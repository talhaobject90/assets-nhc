...
// EDIT QUERY 
		...
		$get_asset_details="SELECT * FROM `".$assets_table."`  WHERE `id` =".$asset_det['asset_id'].";";
		$get_asset= mysql_query($get_asset_details);
		while($get_rows = mysql_fetch_array($get_asset)) {
			$get_ass['name'] = trim($get_rows['name']);
			$get_ass['location'] = trim($get_rows['location']);
			$get_ass['custodian'] = trim($get_rows['custodian']);
			$get_ass['vendor'] = trim($get_rows['vendor']);
			$get_ass['project'] = trim($get_rows['project']);
			$get_ass['department'] = $get_rows['department'];
			$get_ass['asset_category'] = $get_rows['asset_category'];
					...
					<div class="row">
						<div class="page-content col-sm-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<p class="form-control-static"><?php  echo $get_ass['name']?></p>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<p class="form-control-static"><?php  echo $get_ass['asset_category']?></p>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<p class="form-control-static"><?php  echo $get_ass['location']?></p>
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-sm-4 control-label bold"><strong> Custodian : </strong> </label>
									<div class="col-sm-6">
										<p class="form-control-static"><?php  echo $get_ass['custodian']?></p>
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-sm-4 control-label bold"><strong> Manufacturer : </strong> </label>
									<div class="col-sm-6">
										<p class="form-control-static"><?php  echo $get_ass['vendor']?></p>
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-sm-4 control-label bold"><strong> Project : </strong> </label>
									<div class="col-sm-6">
										<p class="form-control-static"><?php  echo $get_ass['project']?></p>
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-sm-4 control-label bold"><strong> Department   : </strong> </label>
									<div class="col-sm-6">
										<p class="form-control-static"><?php  echo $get_ass['department']?></p>
									</div>
								</div>
							...
							<form accept-charset="UTF-8" action="form_print.php" class="form-horizontal"
