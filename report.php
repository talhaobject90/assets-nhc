	...
	<div class="row">
		<div class="canvas col-md-12" id="main-canvas">
			...
			<section class="form col-sm-12" id="purchase">
				<form accept-charset="UTF-8" action="report_gen.php"
						...
						<div class="page-header">
							...
							<div class="row">
								...
								<ul class="nav nav-tabs" role="tablist">
									<li class="active"><a href="#assets_report" role="tab"
					...
					<div class="tab-content">
						<div class="tab-pane   active" id="assets_report">
							...
							<div class="row">
								<div class="page-content col-sm-6">
									...
									<div class="form-group col-sm-12 item-qty form-inline">
										<label for="asset_id_div"> <u>Report Sorting</u>:
										</label> <select class="form-control" id="sort_select"
											name="sort_by">
											...
											<option value="preventive_maintenance">Preventive Maintenance
											</option>
										...
										</select> <br> <br> <select class="form-control"
									...
									<div class="form-group col-sm-12 item-qty">
										<label for="asset_id_div"> Asset status </label> <select
											class="form-control" id="order_select" name="asset_status">
									...
									<div class="form-group col-sm-12 item-qty">
										<label for="asset_id_div"> Asset Category </label> <select
											class="form-control" id="order_select" name="asset_category">
											<option value="">All Categories</option>
												...
												while($category= mysql_fetch_array($all_category)) {
													?>
												<option
												value="<?php  echo $category['asset_category_name'] ;?>"><?php  echo $category['asset_category_name'] ;?></option>
												<?php }?>
											</select>
									</div>
									...
									<div class="form-group col-sm-12 item-qty">
										<label for="asset_id_div"> Manufacturer </label> <select
											class="form-control" id="order_select" name="vendor">
									...
									<div class="form-group col-sm-12 item-qty">
										<label for="asset_id_div"> Project </label> <select
											class="form-control" id="order_select" name="project">
									...
									<div class="form-group col-sm-12 item-qty">
										<label for="asset_id_div"> Department </label> <select
											class="form-control" id="order_select" name="department">
											<option value="">All Departments</option>
												...
												while($departments = mysql_fetch_array($all_departments)) {
													?>
													<option
												value="<?php  echo $departments['department_name'] ;?>"><?php  echo $departments['department_name'] ;?></option>
													<?php }?>
								...
								<div class="page-content col-sm-4">
									<div class="form-group col-sm-16 item-qty ">
										<label for="asset_id_div"> <u>Data Columns </u>:
										</label> <select class="form-control" name="fields[]" multiple
											style="height: 538px;">
							...
							<div style="padding-bottom: 20px;">
								<input class="btn btn-default btn-primary" type="submit"
									name="generate" value="Generate Report"> <a
									href="dashboard.php"><input class="btn btn-default  "
		...
		<div class="tab-pane   " id="project_employees_report">
			...
			<form accept-charset="UTF-8" action="classes.php"
				...
				<div class="row">
					<div class="page-content col-sm-6">
						...
						<div class="form-group col-sm-12 item-qty">
						<label for="asset_id_div"> <u>Report Types </u>:<br>
							<select class="form-control" name="type">
							<option value = "project_employees">Project Employees</option>
							<option value = "projects">Projects</option>
							<option value="tickets">Tickets</option>
							<option value="assets_category">Asset Category</option>
				...
				<div style="padding-bottom: 20px;">
					<input class="btn btn-default btn-primary" type="submit"
						name="report" value="Generate Report"> <a href="dashboard.php"><input
