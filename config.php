...
<ul class="nav nav-tabs" role="tablist">
  ...
  <li><a href="#project" role="tab" data-toggle="tab">Approver Details</a></li>
</ul>
...
<h1>Asset Categories</h1>
<div class="page-menus">
<a href="#"><i class="icon fa fa-plus"></i><span>Approver Detais</span></a></div>
</div>
